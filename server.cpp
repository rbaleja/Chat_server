...
void server::socketStateChanged(QAbstractSocket::SocketState state)
{
    ...
    if (state == QAbstractSocket::UnconnectedState)
        ...
        desc = "The socket is perfoming a host name lookup.";
    else if (state == QAbstractSocket::ConnectingState)
        desc = "The socket has started and establishing a connection.";
    else if (state == QAbstractSocket::ConnectedState)
        desc = "A connection is established.";
    else if (state == QAbstractSocket::BoundState)
        desc = "The socket is bound to an address an port.";
    else if (state == QAbstractSocket::ClosingState)
        desc = "The socket is abaut to close (data may still be waiting to be written).";
